...
export const CHAMPS: Record<GenreImport, ChampImport[]> = {
  produits: [
    ...
    { cle: "designation", libelle: "Désignation", requis: true, indices: ["designation", "libelle", "description", "produit", "article"] },
    {
      ...
      libelle: "Fabricant",
      requis: false,
      aide: "Rapproché du référentiel (casse et accents ignorés), créé s'il est inconnu.",
      indices: ["fabricant", "marque", "constructeur"],
    },
    {
      cle: "categorie",
      libelle: "Catégorie",
      requis: false,
      aide: "Même règle que le fabricant. Sans elle, le produit reste « sans catégorie ».",
      indices: ["categorie", "famille", "type"],
    },
