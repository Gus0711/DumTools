...
import {
  enregistrerProduit as enregistrerProduitNoyau,
  trouverParNom,
  type SaisieProduit,
} from "./ecritures";
import {
...
/* Le rapprochement par NOM (`trouverParNom`) vit dans `./ecritures`, avec la
 * création de produit qui s'en sert — noyau partagé avec le serveur MCP. */
