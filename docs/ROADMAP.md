...
| 2 | **Étude & chiffrage** | Liste de points, catalogue & modèles, **reco automate**, base matériel — et depuis le 2026-07-28 la **BOM d'affaire dérivée** + les prix d'achat (Magasin) — et depuis le 2026-08-07 le **prix de VENTE** (Devis : déboursé × coefficient en cascade, lots, options, remises, TVA) | ~~BOM matériel chiffrable~~ ✅ · ~~prix de vente~~ ✅ — reste la **restitution client** (PDF à en-tête, mentions, CGV) | [`MAGASIN.md`](MAGASIN.md) · [`DEVIS.md`](DEVIS.md) |
